...
function Card (props) {
    ...
    <button type="button" onClick={handleCardDelete} className={`cards__delete-button ${isOwn ? 'cards__delete-button_visible' : 'cards__delete-button_hidden'}`}></button>
    ...
    <div className="cards__name-container">
        ...
        <div className="cards__like-container">
            <button type="button" className={`cards__like-button ${props.card.likes.some((i) => {return i._id === user._id}) && 'cards__like-button_active'}`} onClick={handleLikeClick}/>
